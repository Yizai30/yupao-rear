...
import com.mena.yupao.mapper.UserMapper;
...
import static com.mena.yupao.constant.UserConstant.ADMIN_ROLE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "mena";
...
//            }
            ...
            // 对 tagNameSet 判空，若为空则将 new HashSet<>() 赋给 tagNameSet，防止 NullPointerException
    ...
    public int updateUser(User user, User loginUser) {
        ...
        // 如果是管理员，允许更新任意用户，如果不是管理员，只允许更新当前（自己的信息）
